...
\documentclass[12pt]{article} % fontsize 10pt/11pt/12pt
...
\begin{center}
  \begin{minipage}{0.5\textwidth}
    ...
    Full-stack developer % Title [optional]
  \end{minipage} \hfill
...
\begin{itemize}
  \item Improved accessibility compliance for MOOC.fi platform using React.js
\end{itemize}

\subsection{A Hacker Company Oy \hfill Jan 2024 - Present}
\subsubsection{Full-stack developer \hfill  Helsinki}
\begin{itemize}
  \item Practiced IT-consulting in various organizations
  \item Python, Next.js, TypeScript
\end{itemize}
...
\begin{itemize}
  ...
  \item Master's thesis on open source licenses
  \item Full list of courses: \href{https://github.com/lambdakilo/degree/}{github.com/lambdakilo/degree/}
\end{itemize}

\section{Skills \& Interests}
%===========================%
\begin{description}[itemsep=0pt]
  \item[Technical] Java, Haskell, Rust, PostgreSQL, NoSQL, Kubernetes, Linux, Windows, MacOS
  \item[Language] Finnish (native), English (fluent), Swedish (conversational)
  \item[Interests] Video games, hacker culture, psychology, books, animal rights, active lifestyle
\end{description}
